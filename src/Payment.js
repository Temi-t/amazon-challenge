...
function Payment() {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = await stripe
      ...
      .then(({ paymentIntent }) => {
        ...
        const childDoc = doc(userDocRef, "orders/paymentIntent.id");
        ...
        (function writeUserDetail() {
          ...
          setDoc(userDocRef, shoppingDetails);
        })();
  ...
  const handleChange = (e) => {
    //listen for changes in card elements and display any errors during user input
    setDisabled(e.empty);
  ...
  //console.log(`User data snapshot ===> ${JSON.stringify(userDocData)}`);
  //}
  //};
